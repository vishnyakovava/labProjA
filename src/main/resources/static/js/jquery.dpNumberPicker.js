...
;(function($){
	$.fn.dpNumberPicker = function(){
		...
		this.each(function(){
            ...
            // var s = "<div class='dp-numberPicker-sub'><i class='fa fa-minus'></i></div><input type='text' class='dp-numberPicker-input'";
            ...
            // s += "' /><div class='dp-numberPicker-add'><i class='fa fa-plus'></i></div>";
